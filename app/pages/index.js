...
export default function Home() {
  ...
  return (
    ...
    <main className={styles.main}></main>
                    ...
                    <h1 className={styles.title}><Image src={session.user.image} width="100px" height="100px" style={{borderRadius: '10%', width: '100px !important'}} /> Welcome, {session.user.name}</h1>
